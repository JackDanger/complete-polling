...
React Poll Application in that:
- Each Poll has id, title, description, published status.
- We can create, retrieve, update, delete Polls.
- There is a Search bar for finding Polls by title.
